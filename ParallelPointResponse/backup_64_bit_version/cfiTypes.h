...
/* DEBUG: on */
/* 64-bit system */
typedef int cfiCounter;		    /* default fixed-point type     */
typedef float cfiScalar;		/* default floating-point type  */
...
typedef enum cfiDataType
{
    ...
    /* USING_64_BIT_SYSTEM */
    /* for 64-bit systems */
    counterType = 2,		/* see cfiCounter typedef above */
    scalarType  = 4			/* see cfiScalar typedef above  */
