	...
	if ( samplingMethod != (cfiMeshSamplingMethod)linearInterp )
	{
		switch (valueType)
		{
		  ...
		  case shortType:
			...
			(*sampleValue) = (cfiScalar)(*(((short *)value_ptr) + neighborZeroOffset));
			return;
...
/* FALLTHROUGH */
	  ...
	  case shortType:
		...
		value_ptr = (void *)(((short *)value_ptr) + neighborZeroOffset);

		switch (axisCount)
		{
		  case 4:

			n15 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[15]));
			n14 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[14]));
			n13 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[13]));
			n12 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[12]));
			n11 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[11]));
			n10 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[10]));
			n09 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[9]));
			n08 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[8]));

/* FALLTHROUGH */
		  case 3:

			n07 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[7]));
			n06 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[6]));
			n05 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[5]));
			n04 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[4]));

/* FALLTHROUGH */
		  case 2:

			n03 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[3]));
			n02 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[2]));

/* FALLTHROUGH */
		  case 1:

			n01 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[1]));
			n00 = (cfiScalar)(*(((short *)value_ptr) + neighborOffsets[0]));
		  ...
		  default:
			...
			while ( neighbor_ptr < end_neighbor )
			{
				(*neighbor_ptr++) = (cfiScalar)(*(((short *)value_ptr) + (*neighborOffsets++)));
			}
